...
\begin{figure}[H]
    \centering
    \includegraphics[scale=0.65]{Freqmax_graph.png}
...
contraste est relativement constant entre $0,50 \pm 0,02$ et $0,80 \pm 0,02$ et 
la résolution est également relativement constante entre $(8,3 \pm 0,1)$ cm et 
...
À nouveau, on observe des valeurs relativement constantes pour la résolution et le 
contraste, soit entre $4,4 \pm 0,1$ cm et $9,5 \pm 0,8$ cm et entre $0,41 \pm 0,1$ 
et $ $ respectivement.
