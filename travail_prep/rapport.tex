...
\[S_j(t)=h_{P_jS}(-t).\]
Une fois que la réponse impulsionnelle a été obtenue pour tout emplacement sur la plaque, il a 
...
Ceci a permis de contruire un graphique 2D de la corrélation en fonction de la position pour 
...
%Mentionner l'incertitude relative pour le contraste et la résolution

%Décrire le graphique de corrélation en fcontionde la positon, avec 
