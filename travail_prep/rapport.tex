...
géométries (carré, forme asymétrique, avec et sans trous). 
Du plexiglas et de l'aluminium ont été testés pour 
...
\begin{tabularx}{\columnwidth}{@{} Y{1.00} Y{0.65} Y{0.95} Y{1.45} Y{0.90} @{}}
  \hline
  Matériau & Géométrie & Position du récepteur & Contraste & Résolution \\
  \hline
  \multicolumn{5}{c}{Meilleurs résultats pour le contraste}\\
  \hline
  ...
  \hline
  \multicolumn{5}{c}{Meilleurs résultats pour la résolution}\\
  \hline
