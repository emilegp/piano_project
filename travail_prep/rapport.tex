...
certains paramètres du prototype à conceptualiser. Il a été conclut qu'une plaque asymétrique en plexiglas, ayant % je nommerais les paramètres optimisés
...
au centre des grilles des figures \ref{fig:sfig1} à \ref{fig:sfig6}.  % A VERIFIER AVEC PHILI, je pense pas que 0,0 soit au centre, on a rien mis de négatif
